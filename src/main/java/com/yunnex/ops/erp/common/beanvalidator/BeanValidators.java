 ...
 */
package com.yunnex.ops.erp.common.beanvalidator;
 ...
 * 
 * ConstraintViolation中包含propertyPath, message 和invalidValue等信息. 提供了各种convert方法，适合不同的i18n需求: 1. List
 * <String>, String内容为message 2. List<String>, String内容为propertyPath + separator + message 3.
 ...
 * @version 2013-01-15
 */
public class BeanValidators { //NOSONAR
    ...
    public static void validateWithException(Object object, Class<?>... groups) { // NOSONAR
        WebApplicationContext wac = ContextLoader.getCurrentWebApplicationContext();
        Validator validator = (Validator) wac.getBean("validator");
        Set constraintViolations = validator.validate(object, groups);
        if (!constraintViolations.isEmpty()) {
