...
public class SQLServerDialect implements Dialect {
    ...
    public static final int DEFAULT_LENGTH_15 = 15;
    public static final int DEFAULT_LENGTH_6 = 6;
    public static final int DEFAULT_LENGTH_8 = 8;
    ...
    static int getAfterSelectInsertPoint(String sql) {
        ...
        return selectIndex + (selectDistinctIndex == selectIndex ? DEFAULT_LENGTH_15 : DEFAULT_LENGTH_6);
    }
    ...
    public String getLimit(String sql, int offset, int limit) {
        ...
        return new StringBuffer(sql.length() + DEFAULT_LENGTH_8)
                .append(sql)
