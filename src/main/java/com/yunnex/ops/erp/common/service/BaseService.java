 ...
 */
package com.yunnex.ops.erp.common.service;
...
public abstract class BaseService {
    ...
    public static final int DEFAULT_NUMBER_9 = 9;
    ...
    public static String dataScopeFilter(User user, String officeAlias, String userAlias) {
        ...
        if (StringUtils.isNotBlank(sqlString.toString())){
            return " AND (" + sqlString.substring(DEFAULT_NUMBER_4) + ")";
        }
        return "";
    }
    ...
    public static void dataScopeFilter(BaseEntity<?> entity, String sqlMapKey, String officeWheres, String userWheres) {
        ...
        // 获取到最大的数据权限范围
        String roleId = "";
        int dataScopeInteger = DEFAULT_NUMBER_8;
        for (Role r : user.getRoleList()){
            int ds = Integer.parseInt(r.getDataScope());
            if (ds == DEFAULT_NUMBER_9){
                roleId = r.getId();
                dataScopeInteger = ds;
                break;
