 ...
 */
package com.yunnex.ops.erp.common.supcan;
...
import com.yunnex.ops.erp.common.supcan.annotation.treelist.SupTreeList;
import com.yunnex.ops.erp.common.supcan.annotation.treelist.cols.SupCol;
import com.yunnex.ops.erp.common.supcan.annotation.treelist.cols.SupGroup;
import com.yunnex.ops.erp.common.supcan.treelist.TreeList;
import com.yunnex.ops.erp.common.supcan.treelist.cols.Col;
import com.yunnex.ops.erp.common.supcan.treelist.cols.Group;
...
public class SupcanController extends BaseController {
    ...
    private static Logger logger = LoggerFactory.getLogger(SupcanController.class);
    ...
    public TreeList treeList(@PathVariable("typeAlias") String typeAlias) {
        ...
        for (Method m : clazz.getMethods()){
            ...
            if (supCol != null){
                ...
                if (StringUtils.isBlank(col.getName())){
                    col.setName(StringUtils.uncapitalize(StringUtils.substring(m.getName(),  DEFAULT_NUMBER_3)));
                }
        ...
        Comparator<Object> comparator = new Comparator<Object>() {
            ...
            public int compare(Object o1, Object o2) {
                ...
                return Integer.toString(sort1).compareTo(Integer.toString(sort2));
            }
        };
     ...
     * @param parentId
     */
    private static void listToTree(List<Object> colList, Map<String, Group> groupMap, String parentId, Comparator<Object> comparator){
