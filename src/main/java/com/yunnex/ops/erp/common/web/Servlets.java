...
public class Servlets {
    ...
    // 动态映射URL后缀
    private static final String URL_SUFFIX = Global.getUrlSuffix();
    ...
    public static void setExpiresHeader(HttpServletResponse response, long expiresSeconds) {
        ...
        response.setDateHeader(HttpHeaders.EXPIRES, System.currentTimeMillis() + expiresSeconds * ONE_THOUSAND);
    ...
    public static boolean isAjaxRequest(HttpServletRequest request) {
        ...
        boolean acceptAjax = accept != null && accept.indexOf("application/json") != -1;
        boolean xmlHttpRequest = xRequestedWith != null && xRequestedWith.indexOf("XMLHttpRequest") != -1;
        boolean mobileLogin = principal != null && principal.isMobileLogin();
        return acceptAjax || xmlHttpRequest || mobileLogin;
    }
    ...
    public static boolean isStaticFile(String uri){
        ...
        return StringUtils.endsWithAny(uri, staticFiles) && !StringUtils.endsWithAny(uri, URL_SUFFIX) && !StringUtils.endsWithAny(uri,
                        SUFFIX_JSP) && !StringUtils.endsWithAny(uri, SUFFIX_JAVA);
    }
}
