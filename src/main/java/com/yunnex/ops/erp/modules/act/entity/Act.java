...
import com.yunnex.ops.erp.common.utils.TimeUtils;
...
public class Act extends BaseEntity<Act> {
    ...
    private Date taskStarterDate; // 任务开始执行时间
    private Date taskBusinessEndDate;// 任务预计结束 时间


    private Integer taskDateHours; // 正常任务时间
    private Integer urgentTaskDateHours; // 超时任务时间
    private String taskUserRole;// 用户组
    private Integer taskConsumTime; // 任务进度%比
    private String taskState;
    private String taskUserRole2;// 用户组
    ...
    public String getTaskUserRole2() {
        return taskUserRole2;
    }

    public void setTaskUserRole2(String taskUserRole2) {
        this.taskUserRole2 = taskUserRole2;
    }
    ...
    public Date getTaskBusinessEndDate() {
        return taskBusinessEndDate;
    }

    public void setTaskBusinessEndDate(Date taskBusinessEndDate) {
        this.taskBusinessEndDate = taskBusinessEndDate;
    }
    ...
    public Integer getTaskDateHours() {
        return taskDateHours;
    }

    public void setTaskDateHours(Integer taskDateHours) {
        this.taskDateHours = taskDateHours;
    }

    public Integer getUrgentTaskDateHours() {
        return urgentTaskDateHours;
    }

    public void setUrgentTaskDateHours(Integer urgentTaskDateHours) {
        this.urgentTaskDateHours = urgentTaskDateHours;
    }
