...
package com.yunnex.ops.erp.modules.act.rest.diagram.services;
...
public class BaseProcessDefinitionDiagramLayoutResource {
	...
	public ObjectNode getDiagramNode(String processInstanceId, String processDefinitionId) {//NOSONAR
	...
	private void getActivity(String processInstanceId, ActivityImpl activity, ArrayNode activityArray, ArrayNode sequenceFlowArray,//NOSONAR
			ProcessInstance processInstance, List<String> highLightedFlows, Map<String, ObjectNode> subProcessInstanceMap) {//NOSONAR
