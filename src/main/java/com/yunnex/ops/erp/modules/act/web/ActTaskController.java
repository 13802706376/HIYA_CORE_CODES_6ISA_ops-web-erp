...
public class ActTaskController extends BaseController {
	...
	public String todoList(Act act, HttpServletResponse response, Model model)  {
		...
		return "modules/jyk/actTaskTodoList";
	}
	 ...
	 * 		vars.keys=flag,pass
	 * 		vars.values=1,true
	 * 		vars.types=S,B  @see com.yunnex.ops.erp.modules.act.utils.PropertyType
	 */
	...
	public void tracePhoto(@PathVariable("procDefId") String procDefId, @PathVariable("execId") String execId, HttpServletResponse response) throws IOException  {
