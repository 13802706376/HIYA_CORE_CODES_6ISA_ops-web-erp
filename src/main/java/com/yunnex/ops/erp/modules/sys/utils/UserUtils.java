...
import com.yunnex.ops.erp.modules.sys.dao.AreaDao;
...
public class UserUtils {
    ...
    /**
     * 如果是非服务商, 没有权限; 如果是服务商, 检查是否拥有指定权限.
     * 
     * @param permission
     * @return
     */
    public static Boolean isAgentPermitted(String permission) {
        if (!SysConstant.TYPE_AGENT.equals(getUser().getType())) {
            return false;
        }
