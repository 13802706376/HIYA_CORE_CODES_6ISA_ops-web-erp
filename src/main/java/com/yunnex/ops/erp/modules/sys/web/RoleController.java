...
import com.yunnex.ops.erp.modules.sys.service.OfficeService;
...
public class RoleController extends BaseController {
    ...
    public @ResponseBody List<Role> getAllByType(@RequestParam(required = false, defaultValue = SysConstant.TYPE_AGENT) String type) {
        return roleService.findByType(type);
    }
