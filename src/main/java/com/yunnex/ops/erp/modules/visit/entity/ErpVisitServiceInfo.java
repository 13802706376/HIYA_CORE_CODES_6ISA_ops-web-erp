...
public class ErpVisitServiceInfo extends DataEntity<ErpVisitServiceInfo> {
    ...
    private List<String> serviceUsers; // 上门服务人员,sys_user.id
    ...
    private List<String> teamIds;// 上门服务人员所属团队ID
    ...
    //智慧餐厅开通条件
    private ZhctOpenConditionDto zhctOpenConditionDto;
    
    public ZhctOpenConditionDto getZhctOpenConditionDto() {
		return zhctOpenConditionDto;
	}

	public void setZhctOpenConditionDto(ZhctOpenConditionDto zhctOpenConditionDto) {
		this.zhctOpenConditionDto = zhctOpenConditionDto;
	}
