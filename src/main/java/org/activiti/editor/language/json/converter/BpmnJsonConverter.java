...
public class BpmnJsonConverter implements EditorJsonConstants, StencilConstants, ActivityProcessor {
    ...
    public ObjectNode convertToJson(BpmnModel model) {//NOSONAR
                    ...
                    for (FlowElement flowElement : process.getFlowElements()) {
                        ...
                        for (Lane lane : process.getLanes()) {
                            if (lane.getFlowReferences().contains(lookForElement.getId())) {
                                ...
                                if (laneGraphicInfo != null) {//NOSONAR
                                    laneForElement = lane;
                                }
    ...
    public BpmnModel convertToBpmnModel(JsonNode modelNode) {//NOSONAR
    ...
    private void postProcessElements(FlowElementsContainer parentContainer, Collection<FlowElement> flowElementList, Map<String, JsonNode> edgeMap,//NOSONAR
    ...
    private void readShapeDI(JsonNode objectNode, double parentX, double parentY, Map<String, JsonNode> shapeMap, Map<String, JsonNode> sourceRefMap,//NOSONAR
            BpmnModel bpmnModel) {
    ...
    private void readEdgeDI(Map<String, JsonNode> edgeMap, Map<String, List<JsonNode>> sourceAndTargetMap, BpmnModel bpmnModel) {//NOSONAR
