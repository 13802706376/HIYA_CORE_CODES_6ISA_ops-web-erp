...
public class XMLMapperBuilder extends BaseBuilder {
	...
	private String errorClass = "org.activiti.engine.impl.persistence.entity.MembershipRelation;org.activiti.engine.impl.TablePageMap;org.activiti.engine.impl.persistence.entity.EvenLogEntryEntity";
	
	private static final Log logger = LogFactory.getLog(XMLMapperBuilder.class);

	@Deprecated
	public XMLMapperBuilder(Reader reader, Configuration configuration, //NOSONAR
	...
	private void bindMapperForNamespace() {
		...
		if (namespace != null) {
			...
			try {
				if(!errorClass.contains(namespace)){
