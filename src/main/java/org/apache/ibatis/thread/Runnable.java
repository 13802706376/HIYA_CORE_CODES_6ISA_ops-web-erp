...
public class Runnable implements java.lang.Runnable {
	...
	public static Logger log = Logger.getLogger(Runnable.class);//NOSONAR
	 ...
	 *             文件未找到
	 */
	public void refresh(String filePath, Long beforeTime) throws NestedIOException, FileNotFoundException  {
