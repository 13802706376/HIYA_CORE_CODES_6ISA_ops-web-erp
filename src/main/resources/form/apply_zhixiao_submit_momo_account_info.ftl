...
function submit_${taskId!''}submitForm2001(isLocation){
	var channels =[]; 
	var channelName =[];
	$('input[name="${taskId!''}channelname101"]:checked').each(function(){ 
		channels+=$(this).val()+","; 
	...
	var submit = function (v, h, f) {
			...
			$.post("../jyk/flow/apply_zhixiao_submit_momo_account_info", {
	...
	$.jBox.confirm("确定陌陌推广开户完成吗？", "提示", submit);
}
</script>
...
<div class="act-rs-item  ${detailType!''}  ${followTaskDetailWrap!''}">
	<div class="act-rs-left floatleft">
		<div class="act-rs-title padding15">
			...
			<div class="listSubmit">
				<button  onclick="submit_${taskId!''}submitForm2001()" type="button" class="makesrue btn">确定完成</button>
		...
		<div class="act-rs-form padding15">
			<div class="rs-label">
				<label class="rs-label-wrapper">
					<input type="checkbox"  value="1" name="${taskId!''}channelname101"
			...
			<div class="rs-label">
				<label class="rs-label-wrapper">
					<input type="checkbox"  value="2" name="${taskId!''}channelname101"
						<#if subTaskList?? && (subTaskList?size > 0) ><#list subTaskList as subTask>
	...
	<div class="act-process-left-footer" >
		...
		<div class="footer-btn floatright">
			<button style="button" class="btn btn-large"  onclick="submit_${taskId!''}submitForm2001(1)">确定完成</button>
