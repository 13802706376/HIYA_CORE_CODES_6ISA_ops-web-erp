...
function submit_${taskId!''}submitForm1057(isLocation){
	...
	if(channelName.length === 0) {
		return;
		$.jBox.tip("请确认督促服务商协助商户在公众平台创建新门店！", 'error');
	}
	...
	$.jBox.confirm("确认督促服务商协助商户在公众平台创建新门店吗？", "提示", submit);
}
</script>
		...
		<div class="act-rs-form padding15">
			<div class="rs-label">
				<label class="rs-label-wrapper">
					...
					<span class="subTask" value="1">督促服务商协助商户在公众平台创建新门店</span>
				</label>
			</div>
		</div>
	</div>
