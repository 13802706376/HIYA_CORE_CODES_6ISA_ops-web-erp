...
function submit_${taskId!''}submitForm1055(isLocation){
	...
	var submit = function (v, h, f) {
			...
			$.post("../jyk/flow/accountZhixiao/confirmed_friends_authorization_sucess_zhixiao", {
	...
	$.jBox.confirm("确认完成确认朋友圈授权成功吗？", "提示", submit);
}
		...
		<div class="act-rs-form padding15">
			<div class="rs-label">
				<label class="rs-label-wrapper">
					...
					<span class="subTask" value="1">确认以下门店的朋友圈授权成功</span>
				</label>
			</div>
			<div class="rs-label">
				<label class="rs-label-wrapper">
