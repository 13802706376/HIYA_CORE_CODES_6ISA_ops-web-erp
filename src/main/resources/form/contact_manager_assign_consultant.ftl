<script type="text/javascript">
	function submit_${taskId!''}submitForm1002(isLocation){
		...
		var submit = function (v, h, f) {
				...
				$.post("../jyk/flow/accountZhixiao/contact_manager_assign_consultant", {
		...
		$.jBox.confirm("确认完成联系运营经理指派订单给运营顾问吗？", "提示", submit);
	}
</script>
			...
			<div class="rs-label" style="height:50px;">
				<div class="control-group">
					...
					<label class="rs-label-wrapper">
						...
						<span class="subTask" value="1">确认已经指派运营顾问</span>
					</label>
					-->
				</div>
			</div>
