...
function submit_${taskId!''}submitForm1055(isLocation){
	...
	var submit = function (v, h, f) {
			...
			$.post("../jyk/flow/accountZhixiao/create_stores_on_official_zhixiao", {
		...
		<div class="act-rs-form padding15">
			<div class="rs-label">
				<label class="rs-label-wrapper">
					...
					<span class="subTask" value="1">在公众号平台创建新门店</span>
				</label>
			</div>
		</div>
	</div>
