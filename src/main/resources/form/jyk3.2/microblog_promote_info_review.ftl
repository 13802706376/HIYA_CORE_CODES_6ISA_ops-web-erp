<script type="text/javascript">
	function submit_${taskId!''}submitForm12(isLocation){
		...
		var submit = function (v, h, f) {
				...
				$.post("../microblog/flow/3p2/microblog_promote_info_review", {
		...
		<div class="act-rs-form padding15">
			...
			<div class="rs-label">
				<label class="rs-label-wrapper">
					...
					<input type="radio" name="${taskId!''}isPass" checked="checked" value="Y" class="${taskId!''}isPass"/>是
					<input type="radio" name="${taskId!''}isPass" value="N" class="${taskId!''}isPass"/>否
				</label>
			</div>
			<div class="rs-label">
				<label class="rs-label-wrapper">
