...
function submit_${taskId!''}submitForm1014(isLocation){
	...
	var submit = function (v, h, f) {
			...
			$.post("../jyk/flow/3p2/modify_design_draft_3.2", {
		...
		<div class="task-sider-content">
			<dl class="content-wrap margin-left-0">
				...
				<dd class="margin-left-0">
					<textarea class="content-textarea" readonly placeholder="修改建议"><#if (flowdata.draftFailReason)??>${flowdata.draftFailReason}</#if></textarea>
				</dd>
			</dl>
		</div>
	</div>
...
<script type="text/javascript">
	...
	$(function() {
		var modifyDesignDraft = function() {
			var dde = '',
