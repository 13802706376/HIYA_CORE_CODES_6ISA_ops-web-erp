<script type="text/javascript">
	function submit_${taskId!''}submitForm1002(isLocation){
		var submit = function (v, h, f) {
				...
				$.post("../friends/flow/3p2/modify_friends_promote_info", {
		...
		$.jBox.confirm("确定完修改朋友圈推广开户资料吗？", "提示", submit);
	}
</script>
		...
		<div class="act-rs-form form-horizontal padding15">
			<div class="rs-label">
				<label class="subTask" value="1">
					<span>修改朋友圈推广开户资料：${storeName!''}&nbsp;&nbsp;&nbsp;
						<a href="javascript:;" class="openFriendsForm" data-datas="${storeId!''},zhixiao,edit">
							修改
						</a>&nbsp;&nbsp;
						<font color="red">(驳回原因：${(flowdata.friendsPromotionFlowCheckFailReasonV1)!''})</font>
					</span>
