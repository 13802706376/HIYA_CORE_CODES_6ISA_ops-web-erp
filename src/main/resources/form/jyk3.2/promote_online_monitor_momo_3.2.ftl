<div class="task-detail-wrapper">
   <h3 class="task-title">推广上线监测 - 陌陌</h3>
      ...
      <div class="task-sider-content">
         <dl class="content-wrap">
            ...
            <dd class="margin-left-120">
               <#if (flowdata.momoChannelSelected.promoteStatus)??>
            		<#if flowdata.momoChannelSelected.promoteStatus == 'running'>
            		推广中
            		</#if>
            	</#if>
            </dd>
         ...
         <dl class="content-wrap">
            <dt>推广开始时间：</dt>
            <dd class="margin-left-120">
               <#if (flowdata.momoChannelSelected.promoteStartDate)??>
            		${flowdata.momoChannelSelected.promoteStartDate?string('yyyy-MM-dd')}
            	</#if> 
            </dd>
         </dl>
         <dl class="content-wrap">
...
<script type="text/javascript">
   ...
   $(function() {
      var promotOnlineMonitorMomo = function() {
         var 
         bindEvent = function() {
