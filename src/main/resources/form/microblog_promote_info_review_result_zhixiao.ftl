<script type="text/javascript">
	...
	function submit_${taskId!''}submitForm12(isLocation){
		var submit = function (v, h, f) {
				...
				$.post("../jyk/flow/accountZhixiao/microblog_promote_info_review_result_zhixiao", {
		...
		$.jBox.confirm("确认微博推广开户资料复审吗？", "提示", submit);
	}
...
<input type='hidden' id="${taskId!''}taskId12" name='taskId' value="${taskId!''}"/>
<input type='hidden' id="${taskId!''}procInsId12" name='procInsId'  value="${procInsId!''}"/>
		...
		<div class="act-rs-form padding15">
			<div class="rs-label">
				<label class="rs-label-wrapper">
					<span class="subTask" value="1">微博推广开户提审是否通过：</span>
		...
		<div class="padding15">
			...
			<div class="act-jd">
			 <#if taskConsumTime?? && (taskConsumTime < taskConsumTimeMin) >
					<div class="prog	ress progress-success">
