<script type="text/javascript">
	function submit_${taskId!''}submitForm1002(isLocation){
		var submit = function (v, h, f) {
				...
				$.post("../jyk/flow/accountZhixiao/modify_momo_promote_info_zhixiao", {
		...
		$.jBox.confirm("确定完修改陌陌推广开户资料吗？", "提示", submit);
	}
</script>
			...
			<div class="rs-label" style="height:50px;">
				<div class="rs-label">
					<label class="subTask" value="1">
						<span>修改陌陌推广开户资料：${storeName!''}&nbsp;&nbsp;&nbsp;
							<a href="javascript:;" class="openMomoForm" data-datas="${storeId!''},zhixiao,edit">
								修改
							</a>&nbsp;&nbsp;
