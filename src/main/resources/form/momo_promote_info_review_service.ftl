<script type="text/javascript">
	...
	function submit_${taskId!''}submitForm1002(isLocation){
		...
		var submit = function (v, h, f) {
				...
				$.post("../jyk/flow/accountService/momo_promote_info_review_service", {
						url : $("#${taskId!''}URL").val(),
						isPass : isPass,
		...
		$.jBox.confirm("确认陌陌推广开户提审完成吗？", "提示", submit);
	}
...
<div class="act-rs-item  ${detailType!''}  ${followTaskDetailWrap!''}">
	<div class="act-rs-left floatleft">
		...
		<div class="act-rs-form form-horizontal padding15">
			...
			<div class="control-group">
				<label class="rs-label-wrapper">
					<span class="subTask" value="2">陌陌推广开户提审是否完成：</span>
			...
			<div class="control-group">
				<label class="rs-label-wrapper">
					...
					<a href="../../download/adv/momo?storeId=${storeId!''}" class="downloadForm">《服务商商户陌陌推广开户资料业管录入表》</a>
				</label>
			</div>
		</div>
	</div>
