<script type="text/javascript">
	function submit_${taskId!''}submitForm12(isLocation){
		...
		var submit = function (v, h, f) {
				...
				$.post("../jyk/flow/accountZhixiao/momo_promote_info_review_zhixiao", {
		...
		$.jBox.confirm("确认完成陌陌推广开户资料复审吗？", "提示", submit);
	}
		...
		<div class="act-rs-form padding15">
			...
			<div class="rs-label">
				<label class="rs-label-wrapper">
					...
					<a href="javascript:;" class="openMomoForm" data-datas="${storeId!''},zhixiao">查看</a>
					<a href="../../download/adv/momo?storeId=${storeId!''}" class="downloadForm">《直销商户陌陌推广开户资料业管初审表》</a>
				</label>
			</div>
		</div>
	</div>
