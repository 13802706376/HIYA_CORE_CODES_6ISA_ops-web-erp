<script type="text/javascript">
	function submit_${taskId!''}submitForm1002(isLocation){
		var channelVal = $('input[name="${taskId!''}channelname1002"]:checked').val();
		if(channelVal == ''){
			return;
		}
		var submit = function (v, h, f) {
				...
				$.post("../sdi/flow/need_wechat_pay_shop", {
		...
		$.jBox.confirm("确定完成商户是否开通微信支付吗？", "提示", submit);
	}
</script>
		...
		<div class="act-rs-form form-horizontal padding15">
			<div class="rs-label" style="height:50px;">
				<div class="control-group">
					<label class="subTask" value="1">商户是否需要开通微信支付：</label>
				</div>
			</div>
			<div class="rs-label">
				<div class="stdiv">
