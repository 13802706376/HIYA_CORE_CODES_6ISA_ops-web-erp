<script type="text/javascript">
	function submit_${taskId!''}submitForm1002(isLocation){
		...
		var submit = function (v, h, f) {
				...
				$.post("../jyk/flow/accountZhixiao/perfect_microblog_promote_info_zhixiao", {
			...
			<div class="rs-label" style="height:50px;">
				<div class="control-group">
					<label class="subTask" value="1" style="float: none;">
						<span>提示商户尽快完善以下门店的微博推广开户资料并<a href="../store/basic/erpStoreInfo/weiboCheckUrl/?id=${shopMainId!''}&form=taskList">提交审核</a></span>
					</label><br/>
					<span>
					...
					<label class="rs-label-wrapper">
						...
						<span class="subTask" value="1">确认完善微博推广开户资料</span>
					</label>
					-->
				</div>
			</div>
