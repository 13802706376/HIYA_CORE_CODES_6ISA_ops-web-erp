<script type="text/javascript">
	function submit_${taskId!''}submitForm1002(isLocation){
		...
		var submit = function (v, h, f) {
				...
				$.post("../jyk/flow/accountService/perfect_momo_account_info_service", {
		...
		$.jBox.confirm("确定完成陌陌开户资料补充吗？", "提示", submit);
	}
</script>
		...
		<div class="act-rs-form form-horizontal padding15">
			<div class="rs-label">
				<label class="rs-label-wrapper">
					...
					<span class="subTask" value="1">陌陌开户资料补充</span>
				</label>
			</div>
			<div class="rs-label">
				<label class="rs-label-wrapper">
					<span>选择的门店：${storeName!''}&nbsp;&nbsp;&nbsp;<a href="javascript:;" class="openMomoSupForm" data-datas="${storeId!''},service,edit">补充</a></span>
				</label>
			</div>
		</div>
	</div>
