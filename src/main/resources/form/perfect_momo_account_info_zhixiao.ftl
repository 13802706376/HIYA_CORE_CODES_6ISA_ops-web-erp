<script type="text/javascript">
	function submit_${taskId!''}submitForm1002(isLocation){
		var submit = function (v, h, f) {
				...
				$.post("../jyk/flow/accountZhixiao/perfect_momo_account_info_zhixiao", {
		...
		$.jBox.confirm("确定完陌陌开户资料补充吗？", "提示", submit);
	}
</script>
		...
		<div class="act-rs-form form-horizontal padding15">
			<div class="rs-label">
				<label class="rs-label-wrapper">
					<label class="subTask" value="1" style="display: none;">陌陌开户资料补充：</label>
					<span>陌陌开户资料补充：${storeName!''}&nbsp;&nbsp;&nbsp;
						<a href="javascript:;" class="openMomoSupForm" data-datas="${storeId!''},zhixiao,edit">补充</a>
					</span>
					<input type="text" class="hide" value="1111111111">
				</label>
			</div>
		</div>
	</div>
