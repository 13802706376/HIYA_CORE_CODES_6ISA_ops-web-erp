<script type="text/javascript">
	function submit_${taskId!''}submitForm1002(isLocation){
		...
		var submit = function (v, h, f) {
				...
				$.post("../jyk/flow/accountZhixiao/perfect_momo_promote_info_zhixiao", {
		...
		$.jBox.confirm("确认完成陌陌推广开户资料吗？", "提示", submit);
	}
</script>
			...
			<div class="rs-label" style="height:50px;">
				<div class="control-group">
					<label class="subTask" value="1" style="float: none;">
						<span>提示商户尽快完善以下门店的陌陌推广开户资料并<a href="../store/basic/erpStoreInfo/momoCheckUrl/?id=${shopMainId!''}&form=taskList">提交审核</a></span>
					</label><br/>
					<span>
						已选门店：<a href="../store/basic/erpStoreInfo/admomo/?shopId=${shopMainId!''}&storeId=${storeId!''}&isMain=${isMain!''}&form=taskList">${storeName!''}</a>
					</span>
					<!--
					<label class="rs-label-wrapper">
						...
						<span class="subTask" value="1">确认完善陌陌推广开户资料</span>
					</label>
					-->
				</div>
			</div>
