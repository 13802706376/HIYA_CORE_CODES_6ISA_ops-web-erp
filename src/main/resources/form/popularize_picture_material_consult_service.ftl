...
function submit_${taskId!''}submitForm12(isLocation){
	var submit = function (v, h, f) {
			...
			$.post("../jyk/flow/accountService/popularize_picture_material_consult_service", {
			...
			<div class="rs-label">
				<label class="subTask" value="1">
					<span>选择的门店：${storeName!''}&nbsp;&nbsp;&nbsp;
						<a href="javascript:;" class="showStorePopularizePic" data-datas="${storeId!''},service">查看</a>
					</span>
