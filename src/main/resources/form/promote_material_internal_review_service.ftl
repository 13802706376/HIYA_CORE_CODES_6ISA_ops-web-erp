...
function submit_${taskId!''}submitForm1055(isLocation){
	...
	var submit = function (v, h, f) {
			...
			$.post("../jyk/flow/accountService/promote_material_internal_review_service", {
	...
	$.jBox.confirm("确认完成整合推广素材吗？", "提示", submit);
}
		...
		<div class="act-rs-form padding15">
			<div class="rs-label">
				<label class="rs-label-wrapper">
					...
					<span class="subTask" value="1">整合推广素材</span>
				</label>
			</div>
		</div>
	</div>
