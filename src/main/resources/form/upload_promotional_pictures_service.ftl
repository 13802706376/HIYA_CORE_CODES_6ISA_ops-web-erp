<script type="text/javascript">
	function submit_${taskId!''}submitForm12(isLocation){
		...
		var submit = function (v, h, f) {
				...
				$.post("../jyk/flow/accountService/upload_promotional_pictures_service", {
	...
	<div class="act-rs-left floatleft">
		...
		<div class="act-rs-form padding15">
			<div class="rs-label">
				...
				<a href="javascript:;" class="uploadPromotionalPictures" data-datas="${shopMainId!''},${storeId!''},service">上传图片素材</a>
				<!--
