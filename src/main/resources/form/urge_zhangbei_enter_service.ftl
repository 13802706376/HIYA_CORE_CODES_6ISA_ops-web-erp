...
<div class="act-rs-item  ${detailType!''}  ${followTaskDetailWrap!''}">
	<div class="act-rs-left floatleft">
		...
		<div class="act-rs-form padding15">
			<div class="rs-label">
				<label class="subTask" value="1">督促服务商提交掌贝进件信息</label>
				<!-- <a href="../store/basic/erpStoreInfo/urlErpShopInfoList/?id=${shopMainId!''}&form=taskList">掌贝进件资料</a><br/>
				<a href="../store/basic/erpStoreInfo/zhangbei/?id=${shopMainId!''}&form=taskList">掌贝进件</a> -->
			</div>
		</div>
	</div>
