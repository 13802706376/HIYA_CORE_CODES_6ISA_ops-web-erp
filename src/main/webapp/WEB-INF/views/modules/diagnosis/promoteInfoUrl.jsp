...
<body>
	...
	<script src="${ctxStatic}/common/erpshop.js?v=${staticVersion}033" type="text/javascript"></script>
	...
	<script src="${ctxStatic}/scripts/promoteinfo/promoteinfolist.min.js?v=${staticVersion}" type="text/javascript"></script>
<%-- 	<script src="http://localhost:7777/promoteinfo/promoteinfolist.min.js?v=${staticVersion}" type="text/javascript"></script> --%>
</body>
</html>