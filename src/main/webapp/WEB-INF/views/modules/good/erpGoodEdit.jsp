...
<head>
	...
	<link href="${ctxStatic}/css/commodityOrder/commodity.min.css?v=${staticVersion}" rel="stylesheet" type="text/css" />
...
<body>
	...
	<script src="${ctxStatic}/scripts/commodityOrder/commodity.min.js?v=${staticVersion}" type="text/javascript"></script>
<%-- 		<script src="http://localhost:7777/commodityOrder/commodity.min.js?v=${staticVersion}" type="text/javascript"></script> --%>
</body>
</html>