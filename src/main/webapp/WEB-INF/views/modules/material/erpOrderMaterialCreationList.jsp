...
<head>
	...
	<link href="${ctxStatic}/css/materialproduction/materialproduction.min.css?v=${staticVersion}" rel="stylesheet" type="text/css" />
	<script type="text/javascript">
		...
		var pageDataObject = {
			...
			hasPermissionExport: '<shiro:hasPermission name="material:erpOrderMaterialCreation:export">true</shiro:hasPermission>',
			hasPermissionUpdate: '<shiro:hasPermission name="material:erpOrderMaterialCreation:update">true</shiro:hasPermission>',
			hasPermissionOperate: '<shiro:hasPermission name="material:erpOrderMaterialCreation:operate">true</shiro:hasPermission>'
		};  
	</script>
</head>
<body>
	...
	<script src="${ctxStatic}/scripts/materialproduction/materialproduction.min.js?v=${staticVersion}" type="text/javascript"></script>
	<!-- <script src="http://localhost:7777/materialproduction/materialproduction.min.js?v=${staticVersion}" type="text/javascript"></script> -->
</body>
</html>