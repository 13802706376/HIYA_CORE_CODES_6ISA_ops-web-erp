...
<body>
	...
	<script src="${ctxStatic}/scripts/materialproduction/materialproductionview.min.js?v=${staticVersion}" type="text/javascript"></script>
	<!-- <script src="http://localhost:7777/materialproduction/materialproductionview.min.js?v=${staticVersion}" type="text/javascript"></script> -->
</body>
</html>