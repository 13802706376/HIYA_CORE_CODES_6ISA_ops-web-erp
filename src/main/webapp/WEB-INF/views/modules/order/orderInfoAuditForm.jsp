...
<head>
	...
	<link href="${ctxStatic}/css/order/auditmodel.min.css?v=${staticVersion}" rel="stylesheet" type="text/css" />
...
<body>
	...
	<script src="${ctxStatic}/scripts/order/auditmodel.min.js?v=${staticVersion}" type="text/javascript"></script>
<%-- 	<script src="http://localhost:7777/order/auditmodel.min.js?v=${staticVersion}" type="text/javascript"></script> --%>
</body>
</html>