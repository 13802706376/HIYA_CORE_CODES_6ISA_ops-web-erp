...
<head>
	...
	<link href="${ctxStatic}/css/order/redeploy.min.css?v=${staticVersion}" rel="stylesheet" type="text/css" />
...
<%-- 	<script src="${ctxStatic}/scripts/order/redeploy.min.js?v=${staticVersion}" type="text/javascript"></script> --%>
	<script src="http://localhost:7777/order/redeploy.min.js?v=${staticVersion}" type="text/javascript"></script>
</body>
</html>