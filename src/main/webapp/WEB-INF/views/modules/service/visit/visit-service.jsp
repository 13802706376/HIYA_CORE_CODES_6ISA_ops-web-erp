...
<head>
	...
	<link href="${ctxStatic}/css/visistservice/visistservice.min.css?v=${staticVersion}" rel="stylesheet" type="text/css" />
</head>
<body>
	<div id="rootNode"></div>
	...
	<script src="${ctxStatic}/scripts/visistservice/visistservice.min.js?v=${staticVersion}" type="text/javascript"></script>
	<!-- <script src="http://localhost:7777/visistservice/visistservice.min.js?v=${staticVersion}" type="text/javascript"></script> -->
