...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active">
			<a href="${ctx}/shop/erpShopInfo/toEdit?orderId=${info.orderId}">商户修改</a>
		</li>
	</ul>
	<sys:message content="${message}" />
	<div class="formwrapper positionrelative">
		<form:form id="inputForm" modelAttribute="info" action="${ctx}/shop/erpShopInfo/update" method="post" class="form-horizontal">
			<form:hidden path="id"/>
