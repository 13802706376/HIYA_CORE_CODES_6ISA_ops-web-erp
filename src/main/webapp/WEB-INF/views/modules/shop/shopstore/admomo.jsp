...
<body>
	...
	<script src="${ctxStatic}/scripts/storeinfo/admomo.min.js?v=${staticVersion}" type="text/javascript"></script>
	<!-- <script src="http://localhost:7777/storeinfo/admomo.min.js?v=${staticVersion}" type="text/javascript"></script> -->
</html>