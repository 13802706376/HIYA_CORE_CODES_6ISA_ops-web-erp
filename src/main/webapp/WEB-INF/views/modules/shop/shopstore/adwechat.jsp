...
<body>
	...
	<script src="${ctxStatic}/scripts/storeinfo/adwechat.min.js?v=${staticVersion}" type="text/javascript"></script>
	<!-- <script src="http://localhost:7777/storeinfo/adwechat.min.js?v=${staticVersion}" type="text/javascript"></script> -->
</body>
</html>