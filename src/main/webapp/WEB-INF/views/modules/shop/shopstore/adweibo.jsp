...
<body>
	...
	<script src="${ctxStatic}/scripts/storeinfo/adweibo.min.js?v=${staticVersion}" type="text/javascript"></script>
	<!-- <script src="http://localhost:7777/storeinfo/adweibo.min.js?v=${staticVersion}" type="text/javascript"></script> -->
</body>
</html>