...
<body>
	...
	<script src="${ctxStatic}/scripts/storeinfo/momocheck.min.js?v=${staticVersion}" type="text/javascript"></script>
	<!-- <script src="http://localhost:7777/storeinfo/momocheck.min.js?v=${staticVersion}" type="text/javascript"></script> -->
</body>
</html>