...
<head>
	...
	<link href="${ctxStatic}/css/storeinfo/payaudit.min.css?v=${staticVersion}" rel="stylesheet" type="text/css" />
	<script type="text/javascript">
		...
		var pageDataObject = {
			...
			hasPermissionBy: '<shiro:hasPermission name="shop:auditManage:edit">true</shiro:hasPermission>',
...
<body>
	...
	<script src="${ctxStatic}/scripts/storeinfo/payaudit.min.js?v=${staticVersion}" type="text/javascript"></script>
	<!-- <script src="http://localhost:7777/storeinfo/payaudit.min.js?v=${staticVersion}" type="text/javascript"></script> -->
</body>
</html>