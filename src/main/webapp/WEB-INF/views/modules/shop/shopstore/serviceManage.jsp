...
<head>
	...
	<script type="text/javascript">
		...
		var pageDataObject = {
			...
			operationAdviserName:"${operationAdviserName}"
		};
	</script>
</head>
<body>
	...
	<script src="${ctxStatic}/scripts/storeinfo/servicemanage.min.js?v=${staticVersion}" type="text/javascript"></script>
	<!-- <script src="http://localhost:7777/storeinfo/servicemanage.min.js?v=${staticVersion}" type="text/javascript"></script> -->
</body>
</html>