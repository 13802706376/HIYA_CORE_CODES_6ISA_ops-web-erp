...
<head>
	...
	<script type="text/javascript">
		...
		var apiUrl = '${ctx}/store/basic/erpStoreInfo/getlist/';
		var pageDataObject = {
...
<body>
	...
	<script src="${ctxStatic}/scripts/storeinfo/storemanage.min.js?v=${staticVersion}" type="text/javascript"></script>
	<!-- <script src="http://localhost:7777//storeinfo/storemanage.min.js?v=${staticVersion}" type="text/javascript"></script> -->
</body>
</html>