...
<body>
	...
	<script src="${ctxStatic}/scripts/storeinfo/storebaseinfo.min.js?v=${staticVersion}" type="text/javascript"></script>
	<!-- <script src="http://localhost:7777/storeinfo/storebaseinfo.min.js?v=${staticVersion}8782122" type="text/javascript"></script> -->
</body>
</html>