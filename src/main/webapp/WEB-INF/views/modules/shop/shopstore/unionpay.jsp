...
<head>
	...
	<script type="text/javascript">
		...
		var pageDataObject = {
			...
			auditManagePermission: '<shiro:hasPermission name="shop:auditManage:edit">true</shiro:hasPermission>',
			editPermission: '<shiro:hasPermission name="shop:storeData:edit">true</shiro:hasPermission>',
			advancePermission: '<shiro:hasPermission name="shop:storeData:advancedEdit">true</shiro:hasPermission>'
		};
	</script>
</head>
<body>
	<div id="unionpayWrapper"></div>
	...
	<script src="${ctxStatic}/scripts/storeinfo/unionpay.min.js?v=${staticVersion}e0b8be7ae1e30847d7aa" type="text/javascript"></script>
	<!-- <script src="http://localhost:7777/storeinfo/unionpay.min.js?v=dnskjhdndn2012e0b8be7ae1e30847d7aa" type="text/javascript"></script> -->
</body>
</html>