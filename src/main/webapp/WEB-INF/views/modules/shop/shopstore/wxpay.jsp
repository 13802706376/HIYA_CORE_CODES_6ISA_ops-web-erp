...
<body>
	...
	<script src="${ctxStatic}/scripts/storeinfo/wxpay.min.js?v=${staticVersion}16" type="text/javascript"></script>
	<!-- <script src="http://localhost:7777/storeinfo/wxpay.min.js?v=abchsjdjk20105478816" type="text/javascript"></script> -->
</body>
</html>