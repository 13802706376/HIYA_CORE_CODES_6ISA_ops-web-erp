...
<body>
	...
	<script src="${ctxStatic}/scripts/storeinfo/vipcn.min.js?v=${staticVersion}e0b8be7ae1e30847d7aa" type="text/javascript"></script>
	<!-- <script src="http://localhost:7777/storeinfo/vipcn.min.js?v=${staticVersion}" type="text/javascript"></script> -->
</body>
</html>