...
<head>
	...
	<link href="${ctxStatic}/css/storeinfo/zhangbeilist.min.css?v=${staticVersion}" rel="stylesheet" type="text/css" />
	<script type="text/javascript">
		...
		var pageDataObject = {
			...
			hasPermissionBy: '<shiro:hasPermission name="shop:storeData:edit">true</shiro:hasPermission>',
			advancePermission: '<shiro:hasPermission name="shop:storeData:advancedEdit">true</shiro:hasPermission>'
		};
	</script>
</head>
<body>
	<div id="zhangbeiListWrapper"></div>
	...
	<script src="${ctxStatic}/scripts/storeinfo/zhangbeilist.min.js?v=${staticVersion}" type="text/javascript"></script>
	<!-- <script src="http://localhost:7777/storeinfo/zhangbeilist.min.js?v=f0f1ca8a87a2d71d1d3d" type="text/javascript"></script> -->
</body>
</html>