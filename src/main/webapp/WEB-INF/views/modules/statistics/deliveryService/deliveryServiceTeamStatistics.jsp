...
<head>
	...
	<link href="${ctxStatic}/css/teamOrder/teamOrder.min.css?v=${staticVersion}" rel="stylesheet" type="text/css" />
	<script type="text/javascript">
		...
		var pageDataObject = {
			...
			teamFirst: '<shiro:hasPermission name="order:erpDeliveryServiceStatistics:first">true</shiro:hasPermission>',
			teamTwo: '<shiro:hasPermission name="order:erpDeliveryServiceStatistics:afterSale">true</shiro:hasPermission>',
			teamThree: '<shiro:hasPermission name="order:erpDeliveryServiceStatistics:updateMaterial">true</shiro:hasPermission>'
		};  
	</script>
</head>
<body>
	...
	<script src="${ctxStatic}/scripts/teamOrder/teamOrder.min.js?v=${staticVersion}" type="text/javascript"></script>
<%-- 	<script src="http://localhost:7777/teamOrder/teamOrder.min.js?v=${staticVersion}" type="text/javascript"></script> --%>
</body>
</html>