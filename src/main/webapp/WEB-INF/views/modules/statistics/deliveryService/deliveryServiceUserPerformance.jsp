...
<head>
	...
	<link href="${ctxStatic}/css/teamOrder/teamMemberStatic.min.css?v=${staticVersion}" rel="stylesheet" type="text/css" />
	<style type="text/css">
	...
	<script type="text/javascript">
		...
		var pageDataObject = {
			...
			orderAduit: '<shiro:hasPermission name="team:user:performance:report:order">true</shiro:hasPermission>',
			serviceAduit: '<shiro:hasPermission name="team:user:performance:report:visit">true</shiro:hasPermission>'
		};  
	</script>
</head>
<body>
	...
	<script src="${ctxStatic}/scripts/teamOrder/teamMemberStatic.min.js?v=${staticVersion}" type="text/javascript"></script>
<%-- 	<script src="http://localhost:7777/teamOrder/teamMemberStatic.min.js?v=${staticVersion}" type="text/javascript"></script> --%>
</body>
</html>