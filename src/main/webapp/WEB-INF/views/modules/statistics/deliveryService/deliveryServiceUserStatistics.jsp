...
<head>
	...
	<link href="${ctxStatic}/css/teamOrder/personalOrder.min.css?v=${staticVersion}" rel="stylesheet" type="text/css" />
	<script type="text/javascript">
		...
		var pageDataObject = {
			...
			personalFirst: '<shiro:hasPermission name="order:deliveryServiceStatisticsUserUrl:first">true</shiro:hasPermission>',
			personalTwo: '<shiro:hasPermission name="order:deliveryServiceStatisticsUserUrl:afterSale">true</shiro:hasPermission>',
			personalThree: '<shiro:hasPermission name="order:deliveryServiceStatisticsUserUrl:updateMaterial">true</shiro:hasPermission>'
		};  
	</script>
</head>
<body>
	...
	<script src="${ctxStatic}/scripts/teamOrder/personalOrder.min.js?v=${staticVersion}" type="text/javascript"></script>
<%-- 	<script src="http://localhost:7777/teamOrder/personalOrder.min.js?v=${staticVersion}" type="text/javascript"></script> --%>
</body>
</html>