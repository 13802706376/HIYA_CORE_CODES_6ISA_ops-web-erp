...
<body>
	...
	<script src="${ctxStatic}/scripts/teamOrder/openServiceDetail.min.js?v=${staticVersion}" type="text/javascript"></script>
<%-- 	<script src="http://localhost:7777/teamOrder/openServiceDetail.min.js?v=${staticVersion}" type="text/javascript"></script> --%>
</body>
</html>