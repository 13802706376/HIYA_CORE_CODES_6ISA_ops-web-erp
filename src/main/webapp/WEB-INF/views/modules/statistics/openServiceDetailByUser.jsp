...
<body>
	...
	<script src="${ctxStatic}/scripts/teamOrder/openServiceDetailByUser.min.js?v=${staticVersion}" type="text/javascript"></script>
<%-- 	<script src="http://localhost:7777/teamOrder/openServiceDetailByUser.min.js?v=${staticVersion}" type="text/javascript"></script> --%>
</body>
</html>