...
<body>
	...
	<script src="${ctxStatic}/scripts/teamOrder/servicePage.min.js?v=${staticVersion}" type="text/javascript"></script>
<%-- 	<script src="http://localhost:7777/teamOrder/servicePage.min.js?v=${staticVersion}" type="text/javascript"></script> --%>
