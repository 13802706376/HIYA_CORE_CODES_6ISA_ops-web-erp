		...
		function overJyk(){
			...
			$.ajax({
				...
				success : function(data) {
					$("#overJyk").html("批量执行中...");
					setTimeout(function(){$("#overJyk").html("结束已完成聚引客分支");},5000);
				},
			});
		}
	</script>
...
<body>
	<div id="rootNode"></div>
	<div id="overJyk" onclick="overJyk()">结束已完成聚引客分支</div>
	...
	<script src="${ctxStatic}/scripts/statistics/teamreport.min.js?v=${staticVersion}" type="text/javascript"></script>
<%-- 	<script src="http://localhost:7777/statistics/teamreport.min.js?v=${staticVersion}" type="text/javascript"></script> --%>
</body>
</html>