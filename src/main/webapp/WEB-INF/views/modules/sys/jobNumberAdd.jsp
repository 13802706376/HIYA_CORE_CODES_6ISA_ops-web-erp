...
<head>
	...
	<link href="${ctxStatic}/css/sys/jobnumber.min.css?v=${staticVersion}" rel="stylesheet" type="text/css" />
	<title>工号管理</title>
...
<body>
	...
	<script src="${ctxStatic}/scripts/sys/jobnumber.min.js?v=${staticVersion}" type="text/javascript"></script>
</body>
</html>