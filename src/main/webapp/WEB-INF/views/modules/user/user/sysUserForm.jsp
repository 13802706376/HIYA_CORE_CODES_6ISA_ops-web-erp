...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/user/user/sysUser/">user列表</a></li>
		<li class="active"><a href="${ctx}/user/user/sysUser/form?id=${sysUser.id}">user<shiro:hasPermission name="user:user:sysUser:edit">${not empty sysUser.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="user:user:sysUser:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="sysUser" action="${ctx}/user/user/sysUser/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="user:user:sysUser:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
