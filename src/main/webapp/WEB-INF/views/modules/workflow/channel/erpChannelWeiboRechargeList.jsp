...
<body>
	...
	<script src="${ctxStatic}/scripts/weibochannel/weibochannel.min.js?v=${staticVersion}" type="text/javascript"></script>
	<!-- <script src="http://localhost:7777/weibochannel/weibochannel.min.js?v=${staticVersion}" type="text/javascript"></script> -->
</body>
</html>