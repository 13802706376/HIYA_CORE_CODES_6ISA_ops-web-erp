...
<body>
	...
	<script src="${ctxStatic}/scripts/workflow/openpaydialog.min.js?v=${staticVersion}" type="text/javascript"></script>
	<!-- <script src="http://localhost:7777/workflow/openpaydialog.min.js?v=${staticVersion}" type="text/javascript"></script> -->
</body>
</html>
