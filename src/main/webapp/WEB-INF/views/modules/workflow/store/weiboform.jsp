...
<head>
	...
	<style type="text/css">.hint{position:relative}.hint:before{content:"*";position:absolute;top:5px;right:-6px;color:red}</style>
...
<body>
	...
	<script src="${ctxStatic}/scripts/workflow/weiboform.min.js?v=${staticVersion}" type="text/javascript"></script>
	<%-- <script src="http://localhost:7777/workflow/weiboform.min.js?v=${staticVersion}" type="text/javascript"></script> --%>
</body>
</html>