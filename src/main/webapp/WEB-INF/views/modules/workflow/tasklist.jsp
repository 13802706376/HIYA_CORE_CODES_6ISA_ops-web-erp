...
<body>
	<div class="act-top positionrelative">
		...
		<div class="act-top-right positionrabsolute">
			<!-- <button type="button" class="btn openFriendsForm">
				朋友圈
			</button>
			<button type="button" class="btn openWeiboForm">
				微博
			</button>
			<button type="button" class="btn openMomoForm">
				陌陌
			</button>
			<button type="button" class="btn openMomoSupForm">
				陌陌资料补充
			</button> -->
	...
	<div class="act-wrap">
		...
		<div class="act-content-wrap clear">
			...
			<%-- <jsp:include page="page.jsp" flush="true">
				<jsp:param value="${workFlowQueryForm.total }" name="total"/>
				<jsp:param value="${workFlowQueryForm.pageNo }" name="pageNo"/>
				<jsp:param value="${workFlowQueryForm.pageSize }" name="pageSize"/>
			</jsp:include> --%>
		</div>
	</div>
