							...
							<c:forEach items="${flowFrom.subTaskStrList }" var="i">							
								<div class="act-rs-left floatleft">
									<div class="act-rs-title padding15">
										<h3><a href="../workflow/taskDetail?taskId=${i.taskId}&taskDefKey=${i.subTaskDetail}&startDate=${i.startDate}&endDate=${i.endDate}&splitId=${i.busId}&taskUser=${i.assigneeName}&procInsId=${i.procInsId}">${i.taskName}</a></h3>
									</div>
								</div>
