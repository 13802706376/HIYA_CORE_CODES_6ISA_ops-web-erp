...
<!-- 	<div id="rootNode"></div> -->
	<div class="act-top positionrelative clearfix">				
		<div class="pull-left" style="line-height:30px;">
			<a href="javascript:;" class="comeback btn" id="comeback">返回</a>
			<span style="font-size:16px;font-weight:700">推广数据明细</span>
		</div>
		<div class="pull-right right-top">
			<button type="button" class="btn" id="datasheet" onclick="javascript:window.location.href='result_reports.jsp'">效果报告</button>
			<button type="button" class="btn" id="addUploadData">上传数据</button>
			<button type="button" class="btn" id="addData">新增数据</button>
		</div>
		  ...
		  <div class="tab-pane" id="weixin">
		  	<div class="unfold-info-block">
				<div class="clearfix popularize-box">
					<div class="pull-left">
						<ul class="clearfix list-ul">	
									<li class="pull-left"><span class="list-title">状态：</span><span class="popularize-status">推广中</span></li>	
									<li class="pull-left"><span class="list-title">推广开始时间：</span>2018-03-11</li>	
									<li class="pull-left"><span class="list-title">推广结束时间：</span><span class="popularize-time">/</span></li>	
								</ul>
					</div>
			...
			<div class="unfold-info-block" style="border-bottom: 1px solid #ddd;margin-bottom: 10px;">
				...
				<ul class="clearfix list-ul row">
					<li class="pull-left span3"><span class="list-title">曝光量：</span>123442</li>
					<li class="pull-left span3"><span class="list-title">总消耗：</span>325101201</li>
					<li class="pull-left span3"><span class="list-title">单次曝光成本：</span>20%</li>		
					<li class="pull-left span3"><span class="list-title">详情查看量：</span>200</li>		
					<li class="pull-left span3"><span class="list-title">详情查看率（%）：</span>15244</li>		
					<li class="pull-left span3"><span class="list-title">互动量：</span>2412</li>						
				</ul>
			</div>
			<table class="table">
					<thead>						
		  ...
		  <div class="tab-pane" id="weibo">
			...
			<div class="unfold-info-block" style="border-bottom: 1px solid #ddd;margin-bottom: 10px;">
				...
				<ul class="clearfix list-ul row">
					...
					<li class="pull-left span3"><span class="list-title">总消耗：</span>325101201</li>
					<li class="pull-left span3"><span class="list-title">单次曝光成本：</span>20</li>		
					<li class="pull-left span3"><span class="list-title">导流量：</span>200</li>		
					<li class="pull-left span3"><span class="list-title">导流率（%）：</span>15244</li>		
					<li class="pull-left span3"><span class="list-title">互动量：</span>2412</li>						
				</ul>
			</div>
			<table class="table">
